"""rich_test_21924 URL Configuration
...
admin.site.site_header = "Rich test"
admin.site.site_title = "Rich test Admin Portal"
admin.site.index_title = "Rich test Admin"

# swagger
api_info = openapi.Info(
    title="Rich test API",
    default_version="v1",
    description="API documentation for Rich test App",
)
